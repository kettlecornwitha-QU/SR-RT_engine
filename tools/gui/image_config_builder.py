...
def build_image_render_config(
    *,
    ...
    return ImageRenderConfig(
        ...
        adaptive_threshold=safe_float(settings_dialog.adaptive_threshold, options_schema.adaptive_threshold),
        ...
        atmosphere_density=safe_float(settings_dialog.atmosphere_density, options_schema.atmosphere_density),
        ...
        scatter_spacing_override=optional_override(
            ...
            options_schema.scatter_spacing,
        ),
        scatter_max_radius_override=optional_override(
            ...
            options_schema.scatter_max_radius,
        ),
        scatter_growth_scale_override=optional_override(
            ...
            options_schema.scatter_growth_scale,
        ),
        big_scatter_spacing_override=optional_override(
            ...
            options_schema.big_scatter_spacing,
        ),
        ...
        row_scatter_z_front_override=optional_override(
            ...
            options_schema.row_scatter_z_front,
        ),
        row_scatter_z_back_override=optional_override(
            ...
            options_schema.row_scatter_z_back,
        ),
        row_scatter_replacement_rate_override=optional_override(
            ...
            options_schema.row_scatter_replacement_rate,
        ),
    )
