...
def build_render_task_config(
    *,
    ...
    adaptive_threshold = _safe_float(
        ...
        options_schema.adaptive_threshold,
    )
    atmosphere_density = _safe_float(
        settings_dialog.atmosphere_density,
        options_schema.atmosphere_density,
    )
    atmosphere_color = settings_dialog.atmosphere_color.text().strip() or options_schema.atmosphere_color
